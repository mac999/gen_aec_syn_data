...
(function () {
  const DICT = {
    ko: {
      ...
      "opt.title": "생성 옵션", "grp.dpo": "DPO 선호쌍", "grp.rag": "문서 라우팅", "grp.star": "STaR 검증",
      "opt.apply": "적용",
    ...
    en: {
      ...
      "opt.title": "Generation options", "grp.dpo": "DPO preferences", "grp.rag": "Document routing", "grp.star": "STaR filtering",
      "opt.apply": "Apply",
